...
const Register = () => {
    ...
    return ( 
        <>
            <div className="w-auto sm:w-[300px] lg:w-[400px] text-xs border rounded-[16px]  border-l-[#9fb0e3] border-r-[#4c6ac5] border-y-[#4c6ac5] bg-gradient-to-r from-[#7aa3e4] to-[#374fb9]">
                ...
                {/* Form Input Section */}
                <div className=" px-6 py-2 sm:py-4   text-[#cdd0d8] flex flex-col gap-4 ">
                ...
                <div className="sm:pb-20 px-6 py-2 sm:py-4 text-white  rounded-b-[16px] font-medium flex flex-col gap-2 ">
